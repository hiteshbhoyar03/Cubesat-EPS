...
uint8_t  flagDMATC1 = 0;							// DMA TRANSFER COMPLETE CHANNEL 1 FLAG
uint8_t  flagDMATC3 = 0;							// DMA TRANSFER COMPLETE CHANNEL 3 FLAG
uint16_t adc1_Val[15];								// ADC1 VALUE
uint16_t adc3_Val[6];								// ADC3 VALUE

extern uint8_t sric_2_pmic_rx_buffer[20];			// SRIC-PMIC RX BUFFER
extern uint8_t sric_2_pmic_rx_complete_flag;		// SRIC-PMIC COMPLETE FLAG
extern uint8_t obc_2_pmic_rx_buffer[20];			// OBC-PMIC RX BUFFER
extern uint8_t obc_2_pmic_rx_complete_flag;			// OBC-PMIC COMPLETE FLAG

uint8_t pmic_2_sric_tx_buffer[20];					// PMIC-SR TX BUFFER
uint8_t pmic_2_obc_tx_buffer[20];					// PMIC-OBC TX BUFFER
